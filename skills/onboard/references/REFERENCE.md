...
| File | Description |
|------|-------------|
| `manifest-spec.md` | Full `onboard.yml` schema specification — field-by-field documentation for all manifest sections (prerequisites, setup steps, config prompts, validation, post-setup) |
