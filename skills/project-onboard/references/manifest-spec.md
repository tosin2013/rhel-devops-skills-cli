...
(committed to git) that tells the project-onboard skill what to install, configure, and
...
project-onboard process runs all phases without a deploy step (original behavior).
...
The project-onboard skill searches for the manifest in this order:
