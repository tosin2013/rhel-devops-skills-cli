...
license: Apache-2.0
compatibility: Requires bash 4.4+, git, and Helm. Designed for RHEL 8/9 with Cursor and Claude Code.
metadata:
  related-skills: "patternizer, vp-deploy-test, vp-deploy-validator, vp-submission"
---
