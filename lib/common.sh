...
readonly ALL_SKILLS=("agnosticd" "field-sourced-content" "patternizer" "showroom" "student-readiness" "workshop-tester" "agnosticd-refactor" "vp-refactor" "skill-researcher" "agnosticd-deploy-test" "vp-deploy-test" "vp-deploy-validator" "agnosticd-hub-student" "vp-submission")
